# This is a problem to create a checkout experience following the rules below:
#
# peach -> $5 each basket
# apple -> $2 each basket
...
class FruitFactory
  def self.build(fruit_data)
    ...
    when 'peach'
      ...
      raise "Do not know how to handle this fruit #{fruit_data[0]}. Only know apple, banana and peach."
    end
  end
end
